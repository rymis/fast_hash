// c_cpp_hash_tables_benchmark/shims/std_unordered_map/shim.h
// Copyright (c) 2024 Jackson L. Allan.
// Distributed under the MIT License (see the accompanying LICENSE file).

#include "../../../../cf_hash.hpp"

template< typename blueprint > struct cf_hash
{
  struct hash
  {
  ...
  using table_type = cfhash::cf_hash_map<
...
template<> struct cf_hash< void >
{
  static constexpr const char *label = "cfhash";
  static constexpr const char *color = "rgb( 30, 30, 30 )";
